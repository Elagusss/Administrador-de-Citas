...
class UI {
    ...
    imprimirCitas({citas}) {
        ...
        citas.forEach( cita => {
            ...
            // Scriptin de los elemntos de la cita
...
function nuevaCita(e) {
    ...
    if(editando) {
        ...
        // Regrear el textto del boton al estado original
...
// Carga los datos y el modo de inicion
